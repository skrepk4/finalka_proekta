        ...
        <div className={styles.diagramPage}>
            ...
            <div className={styles.diagramPage__background}>
                <div className={styles.diagramPage__top}>
                    ...
                    <button className={styles.diagramPage__back} onClick={() => navigate("/dashboard")}><img src= {`${import.meta.env.BASE_URL} arrow.png" `} />Повернутись на головну</button>
                    ...
                    <div className={styles.diagramPage__period}>
                        ...
                        <div>
                            <button className={styles.diagramPage__periodButton}><img src={`${import.meta.env.BASE_URL}arrowleft.png `}/></button>  
                            <span className={styles.diagramPage__periodDate}>{currentMonth}</span>
                        <button className={styles.diagramPage__periodButton}><img src={`${import.meta.env.BASE_URL}arrowright.png `} /></button>
                        </div>
                    </div>
                </div>   
